...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='model/v8s.pt', help='training model path')
    ...
    parser.add_argument('--name', type=str, default='yolov8s', help='experiment name (project/name)')
    ...
    parser.add_argument('--retina_masks', action="store_true", help='use high-rsolution segmentation masks')
